...
<link rel="stylesheet"  href="./bikeType.css">
</head>
<body>
<div class="col-md-12 ">
	<div id="toolbar" class="btn-group">
        ...
        <input id="bikeTypeName" type="text" class="search-text" placeholder="输入车型名查询">
        </div>
...
<!-- 摸态框弹窗代码 -->
<%@include file="bikeTypeProcess.jsp" %>
<!-- 引用js -->
