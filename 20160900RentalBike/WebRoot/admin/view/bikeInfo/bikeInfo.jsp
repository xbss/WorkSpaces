...
<link rel="stylesheet"  href="./bikeInfo.css">
</head>
<body>
<div class="col-md-12 ">
	<div id="toolbar" class="btn-group">
        ...
        <input id="bikeId" type="text" class="search-text" placeholder="输入编号查询">
        </div>
...
<!-- 摸态框弹窗代码 -->
<%@include file="bikeInfoProcess.jsp" %>
<!-- 引用js -->
