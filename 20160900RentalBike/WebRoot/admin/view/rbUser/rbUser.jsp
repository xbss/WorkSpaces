...
<link rel="stylesheet"  href="./rbUser.css">
</head>
<body>
<div class="col-md-12 ">
	<div id="toolbar" class="btn-group">
		...
		<button id="btn_delete" class="btn button-primary  button-small "  data-toggle="modal"   data-target="#modal_editPassword"><i class="icon-key "></i> 修改密码</button>
        <div class="search-form">
        <input id="userName" type="text" class="search-text" placeholder="输入姓名查询">
        </div>
...
<!-- 摸态框弹窗代码 -->
<%@include file="rbUserProcess.jsp" %>
<!-- 引用js -->
