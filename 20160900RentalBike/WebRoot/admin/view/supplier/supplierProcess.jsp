			...
			<div class="modal-body">
				<form action="" id="form_add" class="form-horizontal">
                    <div class="form-group">
                        <label for="supplierName" class="col-sm-2  control-label input-sm" >供应商名称</label>
                        <div class="col-sm-10">
                            <input type="text" id="supplierName" name="supplierName" placeholder="" class=" form-control input-sm" required>
                        </div>
                    </div>
                   <div class="form-group">
                        <label for="introduction" class="col-sm-2  control-label input-sm" >供应商简介</label>
                        <div class="col-sm-10">
