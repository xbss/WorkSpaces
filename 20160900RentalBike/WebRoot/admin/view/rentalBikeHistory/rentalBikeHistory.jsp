...
<link rel="stylesheet"  href="./rentalBikeHistory.css">
</head>
<body>
<div class="col-md-12 ">
	<div id="toolbar" class="btn-group">
        ...
        <input id="bikeId" type="text" class="search-text" placeholder="输入车辆编号查询">
        </div>
...
<!-- 摸态框弹窗代码 -->
<%@include file="rentalBikeHistoryProcess.jsp" %>
<!-- 引用js -->
...
<script src="./rentalBikeHistory.js"></script>
</body>
</html>