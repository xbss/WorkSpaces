...
<html>
  ...
  <body >
   	<div align="left" style="width:600px;height:600px;
   	position: absolute;top: 50%;left: 50%;margin-left: -300px;margin-top: -300px;border-radius:60px 10px 60px 10px;box-shadow: 2px 2px 2px 2px rgba(0, 0, 0, .6);background: url('modules/user/image/goodbg.png');">
   		
   		<form action="UserRegister" method="post" style="margin-top:10px;width: 100%;height: auto;">
   			...
   			<input  type="submit" value="注册" style="width:49%;border:none;background: #0593d3;color: #fff;font-size: 1.5em;font-weight: bold;text-align: center;margin-top:30px">
