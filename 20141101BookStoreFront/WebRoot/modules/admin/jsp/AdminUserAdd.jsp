...
<style type="text/css">
  ...
  <body >
   	<div align="left" style="width:600px;;height:100%;">
   		<form action="/modules/admin/jsp/AdminUserAdd.jsp" method="post"  style="margin-top:10px;width: 100%;height: auto;">
	...
	<!-- 加载JS脚本-->
	<script type="text/javascript" src="modules/admin/js/AdminGoodManage.js"></script> 
</html>
