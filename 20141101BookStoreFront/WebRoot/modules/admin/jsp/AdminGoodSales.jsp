  ...
  <body >
   	<div align="left" style="width:600px;;height:100%;">
   		<form action="AdminUserEdit" method="post"  style="margin-top:10px;width: 100%;height: auto;">
   			...
   			<input  type="submit" value="提交修改" style="width:100%;border:none;background: #0593d3;color: #fff;font-size: 1.5em;font-weight: bold;text-align: center;margin-top:30px"><br>
   		</form>
   	</div>
  </body>
